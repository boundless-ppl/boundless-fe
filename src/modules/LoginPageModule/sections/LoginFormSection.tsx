...
export const LoginFormSection = () => {
  ...
  return (
    <div className="overflow-hidden bg-[#f7efe4] px-4 py-8 sm:px-6 sm:py-10">
      <Image
        src="/dunia.png"
        alt="World map"
        width={900}
        height={450}
        className="pointer-events-none absolute bottom-0 left-1/2 w-full max-w-3xl -translate-x-1/2 opacity-[0.06]"
      />
      ...
      <div className="relative mx-auto flex w-full max-w-3xl justify-center">
        <div className="w-full max-w-md rounded-[28px] border border-[#eadfce] bg-white/96 p-6 shadow-[0_18px_40px_rgba(31,31,31,0.06)] backdrop-blur sm:p-8">
          <div className="mb-7 text-center">
            ...
            />
            <h1 className="mt-6 text-[2rem] font-bold tracking-tight text-[#1f2937]">
              Welcome back
            </h1>
