  ...
  return (
    <section className="rounded-[32px] border border-[#eadfce] bg-white px-6 py-8 shadow-[0_18px_40px_rgba(31,31,31,0.06)] sm:px-8">
      ...
      <p className="mt-3 max-w-2xl text-base leading-7 text-[#6b7280]">
        Globalmatch sudah tersedia sekarang. Fitur Beasiswa dan Dreamtracker sedang dalam tahap pengembangan dan akan menyusul.
      </p>
      <div className="mt-6 flex flex-wrap gap-3">
        <Link
          href="/globalmatch"
          className="rounded-2xl bg-[#f58a1f] px-5 py-3 text-sm font-semibold text-white transition-colors hover:bg-[#dd7611]"
        >
          Buka Globalmatch
        </Link>
        <Link
          href="/"
          className="rounded-2xl border border-[#d8d3ca] px-5 py-3 text-sm font-semibold text-[#1f2937] transition-colors hover:bg-[#f7f4ee]"
        >
          Kembali ke Beranda
        </Link>
      </div>
